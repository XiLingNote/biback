...
public class SqlServerPagingInterceptor extends PageInterceptor {
    ...
    protected String getSelectPagingSql(String targetSql, PageBean bounds) {
        ...
        sqlBuilder.insert(0, "SELECT inner_query.*,"+bounds.getTotal()+" as total, ROW_NUMBER() OVER (ORDER BY CURRENT_TIMESTAMP) as __mybatis_row_nr__ FROM ( ");
